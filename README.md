# TripNexus — Comparador de viagens

Site estático (GitHub Pages) que compara preços de viagens em mais de 24 sites parceiros
— Google Voos/Hotéis, Skyscanner, Kayak, Momondo, Trivago, Booking.com, Expedia, Trip.com,
eDreams, Logitravel, Agoda, Airbnb, Vrbo, Hostelworld, Rentalcars.com, Discover Cars,
Auto Europe, GetYourGuide, Civitatis, Viator, Rome2Rio, Omio, Trainline e FlixBus —
e apresenta ao utilizador as opções mais baratas, com cupões aplicados automaticamente
e recomendação de pacotes quando ficam a um valor igual ou com pouca margem acima
das reservas em separado.
...
- **Aba «Ofertas em conta»**: destinos cujo preço actual está bastante abaixo do valor
  típico registado em datas anteriores;
