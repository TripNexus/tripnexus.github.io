# Folha de revisão das tarifas de transportes

Preencha as colunas a **negrito** e devolva a folha. Regras:

- o valor tem de vir da página do operador, não de um guia de viagens;
...
|---|---|---|---|---|
| Bilhete simples (zona A) | 1.5 EUR | por viagem | | |
| Bilhete de 10 viagens | 12.2 EUR | por 10 viagens | | |
...
Abrir: <https://www.vamusalgarve.pt/>
...
Abrir: <https://www.horariosdofunchal.pt/>
...
Abrir: <https://www.titsa.com/index.php/en/>
...
Abrir: <https://www.lignesdazur.com/>
...
### Casablanca  ·  Casa Tramway

Abrir: <https://www.casatramway.ma/>
...
### Recife  ·  Grande Recife Consórcio de Transporte

Abrir: <https://www.granderecife.pe.gov.br/>
...
Abrir: <https://www.transmilenio.gov.co/>
...
### Buenos Aires  ·  Subte (Buenos Aires Ciudad)

Abrir: <https://buenosaires.gob.ar/subte>
...
### Santiago  ·  Red Movilidad

Abrir: <https://www.red.cl/>
...
Abrir: <https://subway.osakametro.co.jp/>
...
### Cidade do Cabo  ·  MyCiTi

Abrir: <https://www.myciti.org.za/en/myconnect-fares/pay-as-you-go/>
...
- Cancún (México): operador ______  ·  endereço ______
- Lima (Peru): operador ______  ·  endereço ______
- Pequim (China): operador ______  ·  endereço ______
- Xangai (China): operador ______  ·  endereço ______
- Seul (Coreia do Sul): operador ______  ·  endereço ______
...
- Praia (Cabo Verde): operador ______  ·  endereço ______
