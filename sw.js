...
const VERSAO = 'tripnexus-v81';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=81',
  './assets/js/analytics.js?v=81',
  './assets/js/data.js?v=81',
  './assets/js/engine.js?v=81',
  './assets/js/calendar.js?v=81',
  './assets/js/live.js?v=81',
  './assets/js/alertas.js?v=81',
  './assets/js/roteiro.js?v=81',
  './assets/js/ui.js?v=81',
  './assets/js/blocks.js?v=81',
  './assets/js/filters.js?v=81',
  './assets/js/results.js?v=81',
  './assets/js/offers.js?v=81',
  './assets/js/search.js?v=81',
  './assets/js/form.js?v=81',
