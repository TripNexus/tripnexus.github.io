...
const VERSAO = 'tripnexus-v36';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=36',
  './assets/js/analytics.js?v=36',
  './assets/js/data.js?v=36',
  './assets/js/engine.js?v=36',
  './assets/js/calendar.js?v=36',
  './assets/js/live.js?v=36',
  './assets/js/alertas.js?v=36',
  './assets/js/roteiro.js?v=36',
