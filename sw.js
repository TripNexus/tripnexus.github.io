...
const VERSAO = 'tripnexus-v75';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=75',
  './assets/js/analytics.js?v=75',
  './assets/js/data.js?v=75',
  './assets/js/engine.js?v=75',
  './assets/js/calendar.js?v=75',
  './assets/js/live.js?v=75',
  './assets/js/alertas.js?v=75',
  './assets/js/roteiro.js?v=75',
  './assets/js/ui.js?v=75',
  './assets/js/blocks.js?v=75',
  './assets/js/filters.js?v=75',
  './assets/js/results.js?v=75',
  './assets/js/offers.js?v=75',
  './assets/js/search.js?v=75',
  './assets/js/form.js?v=75',
