...
const VERSAO = 'tripnexus-v79';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=79',
  './assets/js/analytics.js?v=79',
  './assets/js/data.js?v=79',
  './assets/js/engine.js?v=79',
  './assets/js/calendar.js?v=79',
  './assets/js/live.js?v=79',
  './assets/js/alertas.js?v=79',
  './assets/js/roteiro.js?v=79',
  './assets/js/ui.js?v=79',
  './assets/js/blocks.js?v=79',
  './assets/js/filters.js?v=79',
  './assets/js/results.js?v=79',
  './assets/js/offers.js?v=79',
  './assets/js/search.js?v=79',
  './assets/js/form.js?v=79',
