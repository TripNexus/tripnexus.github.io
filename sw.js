...
const VERSAO = 'tripnexus-v86';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=86',
  './assets/js/analytics.js?v=86',
  './assets/js/data.js?v=86',
  './assets/js/engine.js?v=86',
  './assets/js/calendar.js?v=86',
  './assets/js/live.js?v=86',
  './assets/js/alertas.js?v=86',
  './assets/js/roteiro.js?v=86',
  './assets/js/ui.js?v=86',
  './assets/js/blocks.js?v=86',
  './assets/js/filters.js?v=86',
  './assets/js/results.js?v=86',
  './assets/js/offers.js?v=86',
  './assets/js/search.js?v=86',
  './assets/js/form.js?v=86',
