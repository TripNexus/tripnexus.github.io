...
const VERSAO = 'tripnexus-v78';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=78',
  './assets/js/analytics.js?v=78',
  './assets/js/data.js?v=78',
  './assets/js/engine.js?v=78',
  './assets/js/calendar.js?v=78',
  './assets/js/live.js?v=78',
  './assets/js/alertas.js?v=78',
  './assets/js/roteiro.js?v=78',
  './assets/js/ui.js?v=78',
  './assets/js/blocks.js?v=78',
  './assets/js/filters.js?v=78',
  './assets/js/results.js?v=78',
  './assets/js/offers.js?v=78',
  './assets/js/search.js?v=78',
  './assets/js/form.js?v=78',
