...
const VERSAO = 'tripnexus-v35';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=35',
  './assets/js/analytics.js?v=35',
  './assets/js/data.js?v=35',
  './assets/js/engine.js?v=35',
  './assets/js/calendar.js?v=35',
  './assets/js/live.js?v=35',
  './assets/js/alertas.js?v=35',
  './assets/js/roteiro.js?v=35',
