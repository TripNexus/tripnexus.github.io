...
const VERSAO = 'tripnexus-v77';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=77',
  './assets/js/analytics.js?v=77',
  './assets/js/data.js?v=77',
  './assets/js/engine.js?v=77',
  './assets/js/calendar.js?v=77',
  './assets/js/live.js?v=77',
  './assets/js/alertas.js?v=77',
  './assets/js/roteiro.js?v=77',
  './assets/js/ui.js?v=77',
  './assets/js/blocks.js?v=77',
  './assets/js/filters.js?v=77',
  './assets/js/results.js?v=77',
  './assets/js/offers.js?v=77',
  './assets/js/search.js?v=77',
  './assets/js/form.js?v=77',
