...
const VERSAO = 'tripnexus-v29';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=29',
  './assets/js/analytics.js?v=29',
  './assets/js/data.js?v=29',
  './assets/js/engine.js?v=29',
  './assets/js/calendar.js?v=29',
  './assets/js/live.js?v=29',
  './assets/js/alertas.js?v=29',
  './assets/js/roteiro.js?v=29',
