...
const VERSAO = 'tripnexus-v28';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=28',
  './assets/js/data.js?v=28',
  './assets/js/engine.js?v=28',
  './assets/js/calendar.js?v=28',
  './assets/js/live.js?v=28',
  './assets/js/alertas.js?v=28',
  './assets/js/roteiro.js?v=28',
