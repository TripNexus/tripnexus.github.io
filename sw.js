...
const VERSAO = 'tripnexus-v80';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=80',
  './assets/js/analytics.js?v=80',
  './assets/js/data.js?v=80',
  './assets/js/engine.js?v=80',
  './assets/js/calendar.js?v=80',
  './assets/js/live.js?v=80',
  './assets/js/alertas.js?v=80',
  './assets/js/roteiro.js?v=80',
  './assets/js/ui.js?v=80',
  './assets/js/blocks.js?v=80',
  './assets/js/filters.js?v=80',
  './assets/js/results.js?v=80',
  './assets/js/offers.js?v=80',
  './assets/js/search.js?v=80',
  './assets/js/form.js?v=80',
