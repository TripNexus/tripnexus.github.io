...
const VERSAO = 'tripnexus-v85';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=85',
  './assets/js/analytics.js?v=85',
  './assets/js/data.js?v=85',
  './assets/js/engine.js?v=85',
  './assets/js/calendar.js?v=85',
  './assets/js/live.js?v=85',
  './assets/js/alertas.js?v=85',
  './assets/js/roteiro.js?v=85',
  './assets/js/ui.js?v=85',
  './assets/js/blocks.js?v=85',
  './assets/js/filters.js?v=85',
  './assets/js/results.js?v=85',
  './assets/js/offers.js?v=85',
  './assets/js/search.js?v=85',
  './assets/js/form.js?v=85',
