...
const VERSAO = 'tripnexus-v72';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=72',
  './assets/js/analytics.js?v=72',
  './assets/js/data.js?v=72',
  './assets/js/engine.js?v=72',
  './assets/js/calendar.js?v=72',
  './assets/js/live.js?v=72',
  './assets/js/alertas.js?v=72',
  './assets/js/roteiro.js?v=72',
  './assets/js/ui.js?v=72',
  './assets/js/blocks.js?v=72',
  './assets/js/filters.js?v=72',
  './assets/js/results.js?v=72',
  './assets/js/offers.js?v=72',
  './assets/js/search.js?v=72',
  './assets/js/form.js?v=72',
