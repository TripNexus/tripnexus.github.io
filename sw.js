...
const VERSAO = 'tripnexus-v84';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=84',
  './assets/js/analytics.js?v=84',
  './assets/js/data.js?v=84',
  './assets/js/engine.js?v=84',
  './assets/js/calendar.js?v=84',
  './assets/js/live.js?v=84',
  './assets/js/alertas.js?v=84',
  './assets/js/roteiro.js?v=84',
  './assets/js/ui.js?v=84',
  './assets/js/blocks.js?v=84',
  './assets/js/filters.js?v=84',
  './assets/js/results.js?v=84',
  './assets/js/offers.js?v=84',
  './assets/js/search.js?v=84',
  './assets/js/form.js?v=84',
