...
const VERSAO = 'tripnexus-v88';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=88',
  './assets/js/analytics.js?v=88',
  './assets/js/data.js?v=88',
  './assets/js/engine.js?v=88',
  './assets/js/calendar.js?v=88',
  './assets/js/live.js?v=88',
  './assets/js/alertas.js?v=88',
  './assets/js/roteiro.js?v=88',
  './assets/js/ui.js?v=88',
  './assets/js/blocks.js?v=88',
  './assets/js/filters.js?v=88',
  './assets/js/results.js?v=88',
  './assets/js/offers.js?v=88',
  './assets/js/search.js?v=88',
  './assets/js/form.js?v=88',
