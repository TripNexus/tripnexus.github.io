...
const VERSAO = 'tripnexus-v43';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=43',
  './assets/js/analytics.js?v=43',
  './assets/js/data.js?v=43',
  './assets/js/engine.js?v=43',
  './assets/js/calendar.js?v=43',
  './assets/js/live.js?v=43',
  './assets/js/alertas.js?v=43',
  './assets/js/roteiro.js?v=43',
