...
const VERSAO = 'tripnexus-v89';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=89',
  './assets/js/analytics.js?v=89',
  './assets/js/data.js?v=89',
  './assets/js/engine.js?v=89',
  './assets/js/calendar.js?v=89',
  './assets/js/live.js?v=89',
  './assets/js/alertas.js?v=89',
  './assets/js/roteiro.js?v=89',
  './assets/js/ui.js?v=89',
  './assets/js/blocks.js?v=89',
  './assets/js/filters.js?v=89',
  './assets/js/results.js?v=89',
  './assets/js/offers.js?v=89',
  './assets/js/search.js?v=89',
  './assets/js/form.js?v=89',
