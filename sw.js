...
const VERSAO = 'tripnexus-v71';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=71',
  './assets/js/analytics.js?v=71',
  './assets/js/data.js?v=71',
  './assets/js/engine.js?v=71',
  './assets/js/calendar.js?v=71',
  './assets/js/live.js?v=71',
  './assets/js/alertas.js?v=71',
  './assets/js/roteiro.js?v=71',
  './assets/js/ui.js?v=71',
  './assets/js/blocks.js?v=71',
  './assets/js/filters.js?v=71',
  './assets/js/results.js?v=71',
  './assets/js/offers.js?v=71',
  './assets/js/search.js?v=71',
  './assets/js/form.js?v=71',
