...
const VERSAO = 'tripnexus-v74';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=74',
  './assets/js/analytics.js?v=74',
  './assets/js/data.js?v=74',
  './assets/js/engine.js?v=74',
  './assets/js/calendar.js?v=74',
  './assets/js/live.js?v=74',
  './assets/js/alertas.js?v=74',
  './assets/js/roteiro.js?v=74',
  './assets/js/ui.js?v=74',
  './assets/js/blocks.js?v=74',
  './assets/js/filters.js?v=74',
  './assets/js/results.js?v=74',
  './assets/js/offers.js?v=74',
  './assets/js/search.js?v=74',
  './assets/js/form.js?v=74',
