...
const VERSAO = 'tripnexus-v26';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=26',
  './assets/js/data.js?v=26',
  './assets/js/engine.js?v=26',
  './assets/js/calendar.js?v=26',
  './assets/js/live.js?v=26',
  './assets/js/alertas.js?v=26',
  './assets/js/roteiro.js?v=26',
