...
const VERSAO = 'tripnexus-v73';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=73',
  './assets/js/analytics.js?v=73',
  './assets/js/data.js?v=73',
  './assets/js/engine.js?v=73',
  './assets/js/calendar.js?v=73',
  './assets/js/live.js?v=73',
  './assets/js/alertas.js?v=73',
  './assets/js/roteiro.js?v=73',
  './assets/js/ui.js?v=73',
  './assets/js/blocks.js?v=73',
  './assets/js/filters.js?v=73',
  './assets/js/results.js?v=73',
  './assets/js/offers.js?v=73',
  './assets/js/search.js?v=73',
  './assets/js/form.js?v=73',
