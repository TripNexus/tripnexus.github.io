...
const VERSAO = 'tripnexus-v82';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=82',
  './assets/js/analytics.js?v=82',
  './assets/js/data.js?v=82',
  './assets/js/engine.js?v=82',
  './assets/js/calendar.js?v=82',
  './assets/js/live.js?v=82',
  './assets/js/alertas.js?v=82',
  './assets/js/roteiro.js?v=82',
  './assets/js/ui.js?v=82',
  './assets/js/blocks.js?v=82',
  './assets/js/filters.js?v=82',
  './assets/js/results.js?v=82',
  './assets/js/offers.js?v=82',
  './assets/js/search.js?v=82',
  './assets/js/form.js?v=82',
