...
const VERSAO = 'tripnexus-v76';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=76',
  './assets/js/analytics.js?v=76',
  './assets/js/data.js?v=76',
  './assets/js/engine.js?v=76',
  './assets/js/calendar.js?v=76',
  './assets/js/live.js?v=76',
  './assets/js/alertas.js?v=76',
  './assets/js/roteiro.js?v=76',
  './assets/js/ui.js?v=76',
  './assets/js/blocks.js?v=76',
  './assets/js/filters.js?v=76',
  './assets/js/results.js?v=76',
  './assets/js/offers.js?v=76',
  './assets/js/search.js?v=76',
  './assets/js/form.js?v=76',
