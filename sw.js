...
const VERSAO = 'tripnexus-v70';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=70',
  './assets/js/analytics.js?v=70',
  './assets/js/data.js?v=70',
  './assets/js/engine.js?v=70',
  './assets/js/calendar.js?v=70',
  './assets/js/live.js?v=70',
  './assets/js/alertas.js?v=70',
  './assets/js/roteiro.js?v=70',
  './assets/js/ui.js?v=70',
  './assets/js/blocks.js?v=70',
  './assets/js/filters.js?v=70',
  './assets/js/results.js?v=70',
  './assets/js/offers.js?v=70',
  './assets/js/search.js?v=70',
  './assets/js/form.js?v=70',
