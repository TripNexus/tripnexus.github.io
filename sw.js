...
const VERSAO = 'tripnexus-v87';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=87',
  './assets/js/analytics.js?v=87',
  './assets/js/data.js?v=87',
  './assets/js/engine.js?v=87',
  './assets/js/calendar.js?v=87',
  './assets/js/live.js?v=87',
  './assets/js/alertas.js?v=87',
  './assets/js/roteiro.js?v=87',
  './assets/js/ui.js?v=87',
  './assets/js/blocks.js?v=87',
  './assets/js/filters.js?v=87',
  './assets/js/results.js?v=87',
  './assets/js/offers.js?v=87',
  './assets/js/search.js?v=87',
  './assets/js/form.js?v=87',
