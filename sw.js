...
const VERSAO = 'tripnexus-v120';
const CASCA = [
  './',
  './index.html',
  './assets/css/style.css?v=90',
  './assets/js/analytics.js?v=90',
  './assets/js/data.js?v=90',
  './assets/js/transportes.js?v=90',
  './assets/js/engine.js?v=90',
  './assets/js/calendar.js?v=90',
  './assets/js/live.js?v=90',
  './assets/js/alertas.js?v=90',
  './assets/js/roteiro.js?v=90',
  './assets/js/ui.js?v=90',
  './assets/js/blocks.js?v=90',
  './assets/js/filters.js?v=90',
  './assets/js/results.js?v=90',
  './assets/js/offers.js?v=90',
  './assets/js/search.js?v=90',
  './assets/js/form.js?v=90',
